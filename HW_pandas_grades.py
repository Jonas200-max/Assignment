...
#%% [markdown]
# Try to import data file and make it a dataframe
# If you haven't done so, install rfit package first
# pip install rfit
#%%
import rfit
import os
...
#%%
# Solve the grade-changing exercise (calculating GPA)
# First, load the data frame

dats = rfit.dfapi('Dats_grades')
rfit.dfchk(dats)
#alternatively you can import the csv file directly from the "HW_Pandas" folder
...
#%%
# Question 6
# In one of the previous hw, we wrote a function to convert course total to letter grades. You can use your own, or the one from the solution file here.
...
# Instead of broadcasting some calculations on the dataframe directly, 
# let us USE THE FUNCTION .apply (instead of broadcast) this find_grade() 
